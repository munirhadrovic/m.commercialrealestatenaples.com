<?php
	$adresa="2590 Golden Gate Parkway, Suite 106 Naples, FL 34105"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2394172222;// Broj koji se poziva na dugme CALL US
